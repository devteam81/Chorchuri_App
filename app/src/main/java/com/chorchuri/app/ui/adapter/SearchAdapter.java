...
import com.chorchuri.app.ui.activity.YouTubePlayerActivity;
...
public class SearchAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void takeToVideoPage(ImageView imageView, TextView textView, Video video) {
        if (video.isTrailerVideo()) {
            ...
            toVideo.putExtra(IMAGE, video.getDefaultImage());
            toVideo.putExtra(TITLE, video.getTitle());
            toVideo.putExtra(TRANSITION_IMAGE, "SearchImage");
            toVideo.putExtra(TRANSITION_TITLE, "SearchTitle");
            context.startActivity(toVideo);

            /*Pair<View, String> p1 = Pair.create(imageView, "SearchImage");
            Pair<View, String> p2 = Pair.create(textView, "SearchTitle");
